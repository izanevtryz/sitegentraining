...
/**
 * Collects the data from the logged in profile for a downloadable as a csv file
 */
function datadownload() {
    var profile = customer.profile;
    var gdprHelper = require('~/cartridge/scripts/gdprHelper');
    ...
    response.renderData(gdprHelper.getProfileData(profile), fileName);
    return;
}
